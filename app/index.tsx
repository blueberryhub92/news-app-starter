...
const Page = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.Text style={styles.description} entering={FadeInRight.delay(700).duration(500)}>Get breaking news and personalized updates dirextly to your feed.</Animated.Text>
